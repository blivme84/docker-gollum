...
RUN apt-get install -y -q build-essential python2.7 ruby2.3 python python-docutils ruby-bundler libicu-dev libreadline-dev libssl-dev zlib1g-dev git-core
RUN apt-get clean
